      ...
      <div>
        <div className=' mx-[30rem] pb-[2rem] mt-5 rounded-[30px] border-2 border-red'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="Email" placeholder='Enter the Name' id="name" className='block mx-5 py-[2px] my-4 text-[25px] rounded-[10px] border-2 border-red pl-6 pr-[13rem]' name='email' onChange={handleInputChange}/>
                <label htmlFor="" className='text-[25px] pt-[30px] pl-5 mb-[20px]'>Password: </label>
                <input type="password" placeholder='Enter the Password' id="name" className='block mx-5 my-4 py-[2px] text-[25px] rounded-[10px] border-2 border-red pl-6 pr-[13rem] ' name='password' onChange={handleInputChange}/>
